...
class GeneralApiStack extends cdk.Stack {
    ...
    constructor(scope, id, props) {
        ...
        const idRes = genRes.addResource('{id}');
        genRes.addMethod('POST', new apigateway.LambdaIntegration(putItem));
        idRes.addMethod('GET', new apigateway.LambdaIntegration(getItem));
        idRes.addMethod('DELETE', new apigateway.LambdaIntegration(delItem));
    }
}
